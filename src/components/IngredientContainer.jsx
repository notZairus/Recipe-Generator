...
export default function IngredientContainer({ ingredients }) {
  ...
  return (
     <div className="mt-5">
        ...
        <div className="bg-gray-100 min-h-12 rounded-xl p-4 px-6 flex items-center">
          <div>
          ...
          <button className="bg-red-500 rounded text-white text-xs h-7 w-24">Get a recipe</button>
        </div>
     </div>
  )
}